...
std::list<std::vector<Tile>::iterator> map_chank::get_tile(const sf::Vector2f point){
...
bool auto_loading_map_chank::check_position(const sf::Vector2f point) const{
...
std::shared_ptr<map_chank> auto_loading_map_chank::get(){
